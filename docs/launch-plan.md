...
**Exit criteria:** production deploy succeeds only via promotion of a staging build that ran the full suite; alerts fire in a drill; restore drill documented; checklist signed.
